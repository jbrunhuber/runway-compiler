...
TEST(CODEGEN, LOGICAL_OR) {
  ...
  logical_or_expr->lhs_logical_and_expr = lhs_bool;
  logical_or_expr->rhs_logical_or_expr = rhs_bool;
...
TEST(CODEGEN, LOGICAL_AND) {
  ...
  logical_and_expr->lhs_equality_expr = lhs_bool;
  logical_and_expr->rhs_logical_or_expr = rhs_bool;
